...
public class BookSchema implements DatabaseSchema
{
    ...
    public static String createBookTable = "CREATE TABLE "+ _tableName +" (" +_bookId+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + _bookName+ " VARCHAR(45), " +_roomID+" INTEGER, "+_shelfID +" INTEGER, " + _rowNumber+" INTEGER, " + _bookPosition+ " INTEGER, " + _summary+ " VARCHAR(300) ," + _bookImage +" BLOB );";
