...
public class UserSchema implements DatabaseSchema
{
    ...
    public static final String _createTableUser = "CREATE TABLE "+ _tableName +" (" +_userId+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + _userName+ " VARCHAR(45), " +_userPassword+" VARCHAR(45), " + _userQuestion+" VARCHAR(45), " + _questionAnswer+ " VARCHAR(45));" ;
}
